...
import (
	...
	"github.com/nghia220800/golang-blockchain/blockchain"
)
...
//func for clsoing BadgerDB when close app
...
func HandleAddr(request []byte) {
	...
	fmt.Printf("%d known nodes in network\n", len(KnownNodes))
	RequestBlocks()
}
...
func HandleBlock(request []byte, chain *blockchain.BlockChain) {
	...
	if len(blocksInTransit) > 0 {
		...
		UTXOSet := blockchain.UTXO_set{chain}
		UTXOSet.Reindex()
	}
}
